const translations = {
    es: {
        // General
        header: "Sumérgete en nuestra tierra",
        subtitle: "Huelva no es solo un destino, es un lugar para sentir con el alma y el corazón. Queremos que descubras el encanto de Doñana, el fervor Rociero, la calma de las playas infinitas y las profundidades de la tierra en la Gruta de las Maravillas. Juntos te mostraremos cada lugar como solo nosotros lo conocemos, sintiendo su esencia y conectando con su historia.",
        introduction: [
        ...
        activitiesTitle: "Momentos que dejan huella",
        activitiesIntro: [
        ...
        activities: [
            ...
            { title: "Tierra de pescadores", description: "Relájate y ejercita la paciencia, tan ausente en esta época.  Aprende a pescar en un paraje natural único mientras cierras los ojos e inspiras profundamente la brisa del océano que golpea tu cara; escucha el romper de las olas justo frente a ti." },
            { title: "Huelva Marinera", description: "Naveguemos por la costa como antaño lo hicieron nuestros antepasados y como, aún a día de hoy, lo siguen haciendo nuestros marineros. Disfruta de unas vistas diferentes de la costa y de un baño refrescante." },
            { title: "Orientacíon celeste", description: "Aprende a orientarte en la noche y descubre los secretos del firmamento mientras aprendes a utilizar un telescopio con tus propias manos. Podrás ver los cráteres de la luna y hacer tu primera fotografía astronómica con tu teléfono móvil a través del telescopio." },
            { title: "La fuerza del viento", description: "Aprende a dirigir una cometa de tracción y siente la fuerza del viento en tus propias manos. Descansa y asimila la importancia que tenía aprovechar correctamente los vientos para la navegación a vela que llevó a Colón al descubrimiento del “Nuevo Mundo”." },
            { title: "Fervor Rociero", description: "El Rocío lleva asociado una parte muy espiritual. El Rocío es fe pero también es amistad, es compartir, es recordar a los que ya no están, es un cante y es un baile por sevillanas entre amigos. Como dice la sevillana “Almonte a mi me ha enseñado que el Rocío es todo el año, no solo la romería”." },
            { title: "Paseo en carriola", description: "Disfruta de una afición local como es salir con amigos a pasear en coche de caballos. Aunque en muchas ciudades se trata de un atractivo turístico, aquí, en Huelva, es una afición tradicional asociada a un estilo de vida vinculado al caballo." },
            { title: "Paseo a caballo", description: "Móntate sobre un caballo y siente lo que es controlar un animal de 500Kg. Imagina ir acompañado de miles de caballos tal y como se hace el camino de El Rocío. Ahora, mira hacía abajo para imaginarte como nos vieron los indígenas americanos cuando llegaba un español a caballo." },
            { title: "Senderismo", description: "Perdámonos caminando por una senda entre pinares, elige una buena vara como apoyo y analicemos la flora y la fauna local. Oye el cante de los pájaros y vamos a  intentar distinguirlos e identificarlos." },
            { title: "Cocina con Huelva", description: "Aprende a preparar un arroz con materias primas de la zona. Disfrutemos cocinando un arroz con marisco o un arroz ibérico para posteriormente deleitar nuestro paladar con el exquisito sabor de Huelva y cocinado por uno mismo." },
            { title: "“Cacería” fotográfica", description: "Los locales conocen Doñana con el nombre de “El Coto” por su origen como coto de caza, afición y tradición que perdura en la zona. Cojamos una cámara con zoom y vayamos a “cazar” las mejores fotografías de animales. Mantente oculto, localiza la presa, apunta y dispara." }
        ],
        gastronomyTitle: "Bocados de Huelva",
        gastronomyIntro: [
        ...
        opinions: [
            { text: '"Visitar Huelva fue una experiencia fantástica. Los paisajes son impresionantes y la atención de los guías Javier y Laura fue inmejorable. Nos hicieron sentir como en casa y nos llevaron a lugares que nunca habríamos descubierto por nuestra cuenta. Sin duda, lo mejor del viaje."', author: "- María González" },
            { text: '"Los guías Javier y Laura hicieron que nuestra visita a Huelva fuera especial. Conocían la historia y las tradiciones locales a la perfección, lo que hizo que cada lugar tuviera un significado único. Nos encantó su amabilidad y la forma en que se preocuparon por todos los detalles."', author: "- Carlos Martínez" },
            { text: '"La ruta por Huelva superó todas nuestras expectativas. Los guías Javier y Laura no solo nos mostraron los mejores rincones, sino que también nos compartieron anécdotas y secretos locales que hicieron la experiencia mucho más enriquecedora. ¡Totalmente recomendable para quienes busquen un viaje auténtico!"', author: "- Lucía Fernández" },
            { text: '"Visiting Huelva was truly remarkable. Our guides, Javier and Laura, were exceptional; they were knowledgeable, friendly, and took us to the most beautiful and hidden spots. Their passion for the region was contagious, and they made sure that every moment was memorable. Highly recommended!"', author: "- Sarah Johnson" },
            { text: '"Visiter Huelva a été une expérience inoubliable. Les guides Javier et Laura ont été formidables, toujours disponibles et prêts à partager leur connaissance et leur amour de la région. Ils nous ont fait découvrir des lieux magnifiques et raconté des histoires fascinantes. Je recommande vivement cette aventure."', author: "- Jean Dupont" }
        ],
        contactTitle: "CONTACTO",
        contactDescription: "Estás a punto de comenzar un viaje de descubrimiento como antaño lo hicieron nuestros antepasados para llegar al “Nuevo Mundo”.",
        contactDescription2: "Embárcate en una de nuestras travesías y disfruta descubriendo una tierra de descubridores.",
        formLabels: {
            name: "Nombre",
            email: "Email:",
            phone: "Teléfono:",
    ...
    en: {
        header: "Immerse yourself in our land",
        subtitle: "Huelva is not just a destination, it's a place to feel with your soul and heart. We want you to discover the charm of Doñana, the fervor of El Rocío, the calm of endless beaches, and the depths of the earth in the Gruta de las Maravillas. Together we will show you each place as only we know it, feeling its essence and connecting with its history.",
        introduction: [
        ...
        activitiesTitle: "Moments that leave a mark",
        activitiesIntro: [
        ...
        gastronomyTitle: "Flavors of Huelva",
        gastronomyIntro: [
        ...
        opinions: [
            { text: '"Visiting Huelva was a fantastic experience. The landscapes are stunning and the attention from the guides Javier and Laura was unbeatable. They made us feel at home and took us to places we would never have discovered on our own. Definitely the best part of the trip."', author: "- María González" },
            { text: '"The guides Javier and Laura made our visit to Huelva special. They knew the local history and traditions perfectly, which made each place uniquely meaningful. We loved their kindness and the way they took care of every detail."', author: "- Carlos Martínez" },
            { text: '"The route through Huelva exceeded all our expectations. The guides Javier and Laura not only showed us the best spots, but also shared anecdotes and local secrets that made the experience much richer. Totally recommended for those looking for an authentic trip!"', author: "- Lucía Fernández" },
            { text: '"Visiting Huelva was truly remarkable. Our guides, Javier and Laura, were exceptional; they were knowledgeable, friendly, and took us to the most beautiful and hidden spots. Their passion for the region was contagious, and they made sure that every moment was memorable. Highly recommended!"', author: "- Sarah Johnson" },
            { text: '"Visiting Huelva was an unforgettable experience. The guides Javier and Laura were wonderful, always available and ready to share their knowledge and love for the region. They showed us beautiful places and told us fascinating stories. I highly recommend this adventure."', author: "- Jean Dupont" }
        ],
        contactTitle: "CONTACT",
        contactDescription: "You are about to start a journey of discovery just as our ancestors did to reach the 'New World.'",
        contactDescription2: "Embark on one of our journeys and enjoy discovering a land of discoverers.",
        formLabels: {
            name: "Name",
            email: "Email:",
            phone: "Phone:",
    ...
    fr: {
        header: "Immergez-vous dans notre terre",
        subtitle: "Huelva n'est pas seulement une destination, c'est un lieu à ressentir avec l'âme et le cœur. Nous voulons que vous découvriez le charme de Doñana, la ferveur du Rocío, le calme des plages infinies et les profondeurs de la terre dans la Grotte des Merveilles. Ensemble, nous vous montrerons chaque endroit comme nous seuls le connaissons, en ressentant son essence et en nous connectant à son histoire.",
        introduction: [
        ...
        activitiesTitle: "Des moments qui laissent une empreinte",
        activitiesIntro: [
        ...
        gastronomyTitle: "Saveurs de Huelva",
        gastronomyIntro: [
        ...
        opinions: [
            { text: '"Visiter Huelva a été une expérience fantastique. Les paysages sont impressionnants et l\'attention des guides Javier et Laura a été inégalable. Ils nous ont fait sentir comme chez nous et nous ont emmenés dans des endroits que nous n\'aurions jamais découverts seuls. Sans aucun doute, le meilleur du voyage."', author: "- María González" },
            { text: '"Les guides Javier et Laura ont rendu notre visite à Huelva spéciale. Ils connaissaient parfaitement l\'histoire et les traditions locales, ce qui a donné à chaque lieu une signification unique. Nous avons adoré leur gentillesse et la façon dont ils se sont occupés de chaque détail."', author: "- Carlos Martínez" },
            { text: '"L\'itinéraire à travers Huelva a dépassé toutes nos attentes. Les guides Javier et Laura ne nous ont pas seulement montré les meilleurs endroits, mais ont aussi partagé des anecdotes et des secrets locaux qui ont rendu l\'expérience beaucoup plus enrichissante. Totalement recommandé pour ceux qui recherchent un voyage authentique !"', author: "- Lucía Fernández" },
            { text: '"Visiting Huelva was truly remarkable. Our guides, Javier and Laura, were exceptional; they were knowledgeable, friendly, and took us to the most beautiful and hidden spots. Their passion for the region was contagious, and they made sure that every moment was memorable. Highly recommended!"', author: "- Sarah Johnson" },
            { text: '"Visiter Huelva a été une expérience inoubliable. Les guides Javier et Laura ont été formidables, toujours disponibles et prêts à partager leur connaissance et leur amour de la région. Ils nous ont fait découvrir des lieux magnifiques et raconté des histoires fascinantes. Je recommande vivement cette aventure."', author: "- Jean Dupont" }
        ],
        contactTitle: "CONTACT",
        contactDescription: "Vous êtes sur le point de commencer un voyage de découverte comme l'ont fait nos ancêtres pour atteindre le « Nouveau Monde ».",
        contactDescription2: "Embarquez dans l'un de nos voyages et profitez de la découverte d'une terre de découvreurs.",
        formLabels: {
            name: "Nom",
            email: "Email :",
            phone: "Téléphone :",
...
function changeLanguage(lang) {
    ...
    // INDEX.HTML SECTIONS
    const placeHeader = document.querySelector('.place-container h1');
    if (placeHeader) placeHeader.textContent = translations[lang].header;
    const placeSubtitle = document.querySelector('.place-container span');
    if (placeSubtitle) placeSubtitle.textContent = translations[lang].subtitle;
    const activitiesHeader = document.querySelector('.activities-container h1');
    if (activitiesHeader) activitiesHeader.textContent = translations[lang].activitiesTitle;
    const activityCards = document.querySelectorAll('.activity-card');
    if (activityCards.length && translations[lang].activities) {
        translations[lang].activities.forEach((activity, index) => {
            if (activityCards[index]) {
                const h3 = activityCards[index].querySelector('h3');
                const span = activityCards[index].querySelector('span');
                if (h3) h3.textContent = activity.title;
                if (span) span.textContent = activity.description;
            }
        });
    }
    const plansHeader = document.querySelector('.plans-container h1');
    if (plansHeader) plansHeader.textContent = translations[lang].planHeader;
    const plansDesc = document.querySelector('.plans-container h3');
    if (plansDesc) plansDesc.textContent = translations[lang].planDescription;
    const planCards = document.querySelectorAll('.plan_card');
    if (planCards.length && translations[lang].plans) {
        translations[lang].plans.forEach((plan, index) => {
            if (planCards[index]) {
                const headerSpan = planCards[index].querySelector('.card_header span');
                const h4s = planCards[index].querySelectorAll('h4');
                const ul = planCards[index].querySelector('ul');
                const contentSpan = planCards[index].querySelector('.card_content span');
                if (headerSpan) headerSpan.textContent = plan.title;
                if (h4s[0]) h4s[0].textContent = translations[lang].planLabels.destinations;
                if (ul) ul.textContent = plan.destinations;
                if (h4s[1]) h4s[1].textContent = translations[lang].planLabels.experience;
                if (contentSpan) contentSpan.textContent = plan.experience;
            }
        });
    }
    const opinionsHeader = document.querySelector('.opinions h1');
    if (opinionsHeader) opinionsHeader.textContent = translations[lang].opinionsTitle;
    // FORM
    const formHeader = document.querySelector('.form-container h1');
    if (formHeader) formHeader.textContent = translations[lang].contactTitle;
    const formDesc = document.querySelector('.form-container span');
    if (formDesc) formDesc.textContent = translations[lang].contactDescription;
    const labelName = document.querySelector('label[for="name"]');
    if (labelName) labelName.textContent = translations[lang].formLabels.name;
    const labelEmail = document.querySelector('label[for="email"]');
    if (labelEmail) labelEmail.textContent = translations[lang].formLabels.email;
    const labelTelf = document.querySelector('label[for="telf"]');
    if (labelTelf) labelTelf.textContent = translations[lang].formLabels.phone;
    const labelPeople = document.querySelector('label[for="people"]');
    if (labelPeople) labelPeople.textContent = translations[lang].formLabels.people;
    const labelMessage = document.querySelector('label[for="message"]');
    if (labelMessage) labelMessage.textContent = translations[lang].formLabels.message;
    ...
    // ABOUT-US.HTML SECTIONS
    const aboutUsHeader = document.querySelector('.about-us-container h1');
    if (aboutUsHeader) {
        if (lang === 'es') aboutUsHeader.textContent = 'Sobre nosotros';
        else if (lang === 'en') aboutUsHeader.textContent = 'About us';
        else if (lang === 'fr') aboutUsHeader.textContent = 'À propos de nous';
    }
    const ourSecretHeader = document.querySelector('.our-secret-container h1');
    if (ourSecretHeader) {
        if (lang === 'es') ourSecretHeader.textContent = 'Nuestro secreto';
        else if (lang === 'en') ourSecretHeader.textContent = 'Our secret';
        else if (lang === 'fr') ourSecretHeader.textContent = 'Notre secret';
    }
}
